...
$sql = "SELECT * FROM tasks WHERE user_id = $user_id ORDER BY status DESC, created_at DESC";
...
<div class="container">
    ...
    <?php if ($result->num_rows === 0): ?>
        <div class="empty-state">
            ...
            <h3>Nada por aqui ainda<span class="dot">.</span></h3>
            <p>O teu quadro está limpo. Começa a organizar o teu dia criando a tua primeira tarefa.</p>
